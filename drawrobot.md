...
### 9. **Rapport et Documentation (Mandatory)**
- Un rapport structuré doit être créé et maintenu dans le dossier `RapportECE/`.
- **Règle d'or :** Le rapport doit être mis à jour systématiquement pour chaque changement apporté au code ou à l'architecture du projet afin de garantir une documentation toujours fidèle à la réalité technique.
